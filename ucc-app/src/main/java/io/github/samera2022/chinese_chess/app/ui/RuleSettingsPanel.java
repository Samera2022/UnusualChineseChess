...
import io.github.samera2022.chinese_chess.app.ui.filter.DocumentInputFilter;
...
public class RuleSettingsPanel extends JPanel {
    ...
    private void addTextArea(RuleRegistry rule, JPanel panel, int indentLevel) {
        ...
        // 限制输入为数字
        ((AbstractDocument) textField.getDocument()).setDocumentFilter(new DocumentInputFilter() {
            @Override
