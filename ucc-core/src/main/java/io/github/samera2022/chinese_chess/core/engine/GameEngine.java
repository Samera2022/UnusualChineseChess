...
public class GameEngine implements GameStateAccessor, GameSession {
    ...
    private final RulesConfigProvider.InstanceChangeListener providerListener = (oldInst, newInst) -> {
        ...
        try {
            ...
            if (this.validator != null) this.validator = new MoveValidator(board, newInst);
        } finally {
            engineLock.unlock();
        }
    };
    ...
    private final ConcurrentHashMap<SessionListener, GameStateListener> sessionListenerMap = new ConcurrentHashMap<>();
    ...
    public GameEngine(GameRulesConfig injectedRulesConfig) {
        ...
        this.validator = new MoveValidator(board, this.rulesConfig);
    ...
    public void setRulesConfig(GameRulesConfig newConfig) {
        ...
        try {
            ...
            if (this.validator != null) this.validator = new MoveValidator(board, newConfig);
        } finally {
            engineLock.unlock();
        }
    }
